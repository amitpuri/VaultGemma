...
class HuggingFaceProvider(BaseProvider):
    """Hugging Face model provider for VaultGemma."""
    
    def __init__(self, authenticator=None):
        """Initialize Hugging Face provider.
        
        Args:
            authenticator: Hugging Face authenticator instance.
        """
    ...
    def load_model(self, model_name: str, config: Optional[ModelConfig] = None) -> Tuple[Any, Any]:
        ...
        try:
            ...
            raise ModelLoadError(f"Failed to load Hugging Face model '{model_name}': {e}")
